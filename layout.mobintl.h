...
static struct key keys_full[] = {
  ...
  {"←", "←", 2.0, Code, KEY_LEFT, .scheme = 1},
  {"↓", "↓", 2.0, Code, KEY_DOWN, .scheme = 1},
  {"↑", "↑", 2.0, Code, KEY_UP, .scheme = 1},
  {"→", "→", 2.0, Code, KEY_RIGHT, .scheme = 1},
  {"", "", 0.0, EndRow},
  ...
  {"a", "A", 1.0, Code, KEY_A, &layouts[Emoji]},
  {"z", "Z", 1.0, Code, KEY_Z, &layouts[Emoji]},
  ...
  {"q", "Q", 1.0, Code, KEY_Q, &layouts[ComposeA]},
  ...
  {"w", "W", 1.0, Code, KEY_W, &layouts[ComposeZ]},
...
static struct key keys_special[] = {
  ...
  {"1", "~", 1.0, Copy, 0x0031, 0, 0x007E},
  {"2", "`", 1.0, Copy, 0x0032, 0, 0x0060},
  {"3", "|", 1.0, Copy, 0x0033, 0, 0x007C},
  {"4", "•", 1.0, Copy, 0x0034, 0, 0x2022},
  {"5", "√", 1.0, Copy, 0x0035, 0, 0x221A},
  {"6", "π", 1.0, Copy, 0x0036, 0, 0x03C0},
  {"7", "÷", 1.0, Copy, 0x0037, 0, 0x00F7},
  {"8", "§", 1.0, Copy, 0x0038, 0, 0x00A7},
  {"9", "×", 1.0, Copy, 0x0039, 0, 0x00D7},
  {"0", "∆", 1.0, Copy, 0x0030, 0, 0x2206},
  {"", "", 0.0, EndRow},

  {"@", "£", 1.0, Copy, 0x0040, 0, 0x00A3},
  {"#", "¥", 1.0, Copy, 0x0023, 0, 0x00A5},
  {"€", "$", 1.0, Copy, 0x20AC, 0, 0x0024},
  {"_", "¢", 1.0, Copy, 0x005F, 0, 0x00A2},
  {"&", "^", 1.0, Copy, 0x0026, 0, 0x005E},
  {"-", "°", 1.0, Copy, 0x002D, 0, 0x00B0},
  {"+", "=", 1.0, Copy, 0x002B, 0, 0x003D},
  {"(", "{", 1.0, Copy, 0x0028, 0, 0x007B},
  {")", "}", 1.0, Copy, 0x0029, 0, 0x007D},
  {"/", "\\", 1.0, Copy, 0x002F, 0, 0x005C},
  {"", "", 0.0, EndRow},

  {"=\\<", "?123", 2.0, Mod, Shift, .scheme = 1},
  {"*",  "%", 1.0, Copy, 0x002A, 0, 0x0025},
  {"\"", "©", 1.0, Copy, 0x0022, 0, 0x00A9},
  {"'",  "®", 1.0, Copy, 0x0027, 0, 0x00AE},
  {":",  "™", 1.0, Copy, 0x003A, 0, 0x2122},
  ...
  {",",  "<", 1.0, Copy, 0x002C, 0, 0x003C},
  {"", "", 4.0, Code, KEY_SPACE},
  {".", ">", 1.0, Copy, 0x002E, 0, 0x003E},
  {"Enter", "Enter", 2.0, Code, KEY_ENTER, .scheme = 1},
